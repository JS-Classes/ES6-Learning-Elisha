...
//let numbers = /[0-9]/g;
let numbers = /\d+/g;  //+, *, ? are called quantifiers
//let numbers=/\d*/g;
...
let mail = 'abc@xyz.com elisha.maharjan@cotiviti.com'
let regexmail = /[a-z, A-Z,.]+\w*@[a-z]+.(com|net)/g;  //+, *, ? are called quantifiers
//let numbers=/\d*/g;
let match = mail.match (regexmail);
